 ...
 */
class sfValidatorViettelTable extends sfValidatorBase {
  ...
  protected function doClean($value) {
    /**
     * Kiem tra xem dieu kien value truyen vao co rong hay ko? Neu rong thi thoat luon 
     */
    if ($value && count($value) && !$value[0])
      unset($value[0]);
