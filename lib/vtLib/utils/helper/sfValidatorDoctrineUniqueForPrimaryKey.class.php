 ...
 */
class sfValidatorDoctrineUniqueForPrimaryKey extends sfValidatorSchema {
   ...
   * 
   * customize: tungtd2
   * validator primary key in new form
   * 
   */
  protected function configure($options = array(), $messages = array()) {
    ...
    /*
     * add option isNew to check new form
     * type: boolean
     * @tungtd2
     */

    $this->addOption('isNew', false);
