...
/**
 * DetailOrder filter form base class.
 *
 * @package    source
 * @subpackage filter
 ...
 */
abstract class BaseDetailOrderFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'product_name' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('detail_order_filters[%s]');
